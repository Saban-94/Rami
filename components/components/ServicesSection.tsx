...
import { 
  Cloud, Code2, Cpu, Globe, 
  Layers, Lock, Share2, Terminal,
  Database, Zap, Infinity, BarChart3
} from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass p-8 rounded-[2.5rem] border border-white/10 hover:border-cyan-500/50 transition-all group"
            >
        ...
        >
          ...
          <button 
            ...
            className="px-10 py-4 bg-white text-blue-700 font-black rounded-2xl hover:scale-105 transition-transform"
          >
            בוא נתחיל לבנות
          </button>
        </motion.div>
